...
/*Exportar como JSON [Probado en MSSQL 2017]
SELECT
	Provincias.ProvinciaID AS [Codigo]
	, Provincias.Nombre AS [Nombre]
	, Municipios.MunicipioID AS [Codigo]
	, Municipios.Nombre AS [Nombre]
	, DistritosMunicipales.DistritoID AS [Codigo]
	, DistritosMunicipales.Nombre AS [Nombre]
FROM Provincias
	JOIN Municipios
...
FOR JSON AUTO, ROOT('ProvinciasRD')
*/